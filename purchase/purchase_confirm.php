...
if (isset($_GET['status']) && !empty($_GET['status']) && $_GET['status'] == 'cancelled') {
    ...
    if ($response->status == 'success') {
        if ($response->data->meta->price >= $response->data->charged_amount) {
            ...
            echo '<span style="color:red;"><b>Please do not close this page yet.</b></span>';
            echo 'Please check that your <b>Application Number</b> and <b>PIN Code</b> has been sent to both your email address and phone number!';
            echo 'Then, proceed to the online applicatioin <a href="../apply"><b>portal</b></a> to complete your application.<br>';
