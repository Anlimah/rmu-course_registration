                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="step-1" style="margin: auto 20%;">
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="cert-type"> Certificate Earned <span class="input-required">*</span></label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="completion-date">Exam Date <span class="input-required">*</span></label>
