                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="step-1" style="margin: auto 20%;">
                                <div class="mb-4">
                                    <label class="form-label" for="school1">University Name <span class="input-required">*</span></label>
                                    <input class="form-control" type="text" name="school1" id="school1" placeholder="School Name">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" for="school1">University Country <span class="input-required">*</span></label>
                                    <input class="form-control" type="text" name="school1" id="school1" placeholder="School Name">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" for="school1">University City <span class="input-required">*</span></label>
                                    <input class="form-control" type="text" name="school1" id="school1" placeholder="School Name">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" for="school1">University Province/Region <span class="input-required">*</span></label>
                                    <input class="form-control" type="text" name="school1" id="school1" placeholder="School Name">
                                </div>
                                <div class="mb-4">
